...
namespace Lab1.Excercises.Register.Step6
{
    static class InOutUtils
    {
        ...
        {
            string[] lines = new string[Dogs.Count + 3];
            ...
            Dog selectedDogs = TaskUtils.FindOldestDog(Dogs);

            lines[Dogs.Count + 1] = "Seniausias iš išrinktų:";
            lines[Dogs.Count + 2] = String.Format("{0};{1};{2}", selectedDogs.Name, selectedDogs.Breed, selectedDogs.Gender);
